    ...
    return (
        <div className="max-w-xl mx-auto px-4 py-8 bg-gray-900 rounded-lg shadow-lg" style={{ marginTop: "20px" }}>
            <div className="bg-gray-900 rounded-lg p-8">
                <h1 className="text-4xl font-bold text-center mb-6 text-white">¡Explora la emoción de la Acción!</h1>
                <p className="text-lg text-gray-300 leading-relaxed">
                    Sumérgete en un mundo de emociones intensas y adrenalina pura. En esta sección, encontrarás las mejores películas de acción de todos los tiempos, llenas de explosiones, persecuciones y héroes valientes.
                </p>
